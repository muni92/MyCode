...
variable "container_name_from_root" {
    ...
    type = string
    default = "defaultContainerNamefromRootModule"   # override this if you want to change the name used by the chi
}

variable "external_port" {
  description = "External port on the container_fromRoot"
  type = number
  default = 2228
}
